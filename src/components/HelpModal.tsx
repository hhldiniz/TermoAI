...
export default function HelpModal({
    ...
    <>
      ...
      <div className="flex flex-col gap-2 font-black uppercase tracking-wider text-[9px]">
        <div className="flex items-center gap-2">
          <span className="w-14 shrink-0 text-center bg-[#10b981] text-white rounded py-0.5">{t('VERDE', 'GREEN', 'VERDE')}</span>
        ...
        <div className="flex items-center gap-2">
          <span className="w-14 shrink-0 text-center bg-[#b59f3b] text-white rounded py-0.5">{t('AMARELO', 'YELLOW', 'AMARILLO')}</span>
          <span className="text-[#818384] font-semibold tracking-tight normal-case">
        ...
        <div className="flex items-center gap-2">
          <span className="w-14 shrink-0 text-center bg-[#3a3a3c] text-[#818384] border border-[#3a3a3c] rounded py-0.5">{t('CINZA', 'GRAY', 'GRIS')}</span>
          <span className="text-[#818384] font-semibold tracking-tight normal-case">
  ...
  const enigmaRules = (
    <ul className="list-disc pl-4 flex flex-col gap-1 text-[#818384] font-bold">
  ...
  return (
    <div id="help-modal-backdrop" className="absolute inset-0 bg-[#121213]/90 flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
      <div
        id="help-modal-content"
        role="dialog"
        aria-modal="true"
        aria-labelledby="help-modal-title"
        className="w-full max-w-sm bg-[#1a1a1b] border border-[#3a3a3c] rounded p-6 shadow-xl relative flex flex-col gap-4 select-none"
      >
        <button
        ...
        <div className="text-[11px] text-slate-300 leading-normal text-left">
